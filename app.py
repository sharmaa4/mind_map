...
# Add this block RIGHT AFTER the streamlit import
st.markdown("""
<style>
body, .reportview-container {
    background: linear-gradient(120deg, #f6f9fb 0%, #e9ecfc 100%) !important;
...
.stButton>button:hover {
    ...
    background: linear-gradient(90deg, #4158d0, #42e695);
}
.stMetric {
    background: #fff;
    border-radius: 9px;
    box-shadow: 0 2px 16px rgba(100, 60, 220,0.08);
    padding: 1em;
    margin: 0.7em 0.1em;
}
.stExpander {
...
.card {
    background: #fff;
    border-radius: 15px;
    box-shadow: 0 2px 14px rgba(120,76,204,0.09);
    padding: 1.4em 2em;
    margin-bottom: 1.2em;
    transition: box-shadow 0.17s;
}
.card:hover {
    box-shadow: 0 8px 32px rgba(65, 88, 208, 0.18);
